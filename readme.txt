...
Auto-register manually uploaded images (in `wp-content/uploads`) into the WordPress Media Library. Scans when you open the Media Library, plus a one-click **Scan Missing Images** button and an optional **Deep Scan** for all uploads.
...
**Privacy**  
This plugin does not collect or transmit any personal data. All scanning happens on your server. No external calls are made.
